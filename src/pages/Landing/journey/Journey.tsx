...
const Journey = () => {
  return (
    <div className="max-w-6xl mx-auto py-20 grid grid-cols-1 md:grid-cols-2 gap-20">
      <div>
        ...
        <p className="text-sm ">
          ...
          lessons, offering introductory sessions for beginners and personalized
          development plans to foster individual growth.
        </p>
